 ...
 */
public class WalletMeaningfulException extends BaseTaggableObject
     ...
     */
    @Deprecated
    public WalletMeaningfulException(NetworkParameters params) {
     ...
     */
    @Deprecated
    public WalletMeaningfulException(Context context) {
    ...
    public WalletMeaningfulException(NetworkParameters params, KeyChainGroup keyChainGroup) {
        this(Context.getOrCreate(params), keyChainGroup);
    }

    private WalletMeaningfulException(Context context, KeyChainGroup keyChainGroup) {
    ...
    public void saveToFile(File f) throws IOException {
        ...
        if (!directory.exists()) {
        	throw new IOException(" directory " + directory.getName() + " does not exist");
        }
